...
public class TestClass {
    ...
    // solo si no hay espacio en la cadena
    ...
    public static set delta(int state,char c){
        ...
        switch (state){
            ...
            case 4:
                ...
                // comillas dobles, cambio cadi por tk
    ...
    public static void main(String args []) throws IOException {
        ...
        while((cadena = br.readLine()) != null){
            ...
            for (int i = 0; i < cadena.length()  ; i++) {
                ...
                if (sicadi == true && only == true){cadi = i;
                    only = false;
                }
                if (sichri == true && only2 == true){chri = i;
                    only2 = false;
                }
                ...
                if(com == false){
                    if(s.word !="" || s.word !="blank"){
                        ...
                        //System.out.println("response: "+s.movdelta+" in: "+i);
                        ...
                        switch (s.word){
                            ...
                            case "cadi":
                                if (sicadi == false){
                                    //System.out.println("sicadi is false!!");
                                    cadi = i;
                                    bk = i;
                                }
                                break;
